          ...
          <div className="max-w-2xl w-full h-auto my-10 grid grid-cols-2 justify-items-center mr:grid-cols-1">
            {fetchedProfile.blogs.map((blog, key) => (
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="w-64 h-24 border-2 border-secondary-200 text-secondary-100 my-3 text-center bg-white rounded transform cursor-pointer hover:bg-secondary-300 hover:scale-105 transition-all"
              >
